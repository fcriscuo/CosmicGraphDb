...
fun loadCosmicCompleteCNA(cna: CosmicCompleteCNA): String =
    Neo4jConnectionService.executeCypherCommand(
        "MERGE (cna:CosmicCompleteCNA{cnv_id: ${cna.cnvId}}) " +
                " SET cna.sample_name = \"${cna.sampleName}\", cna.total_cn = ${cna.totalCn}, " +
                " cna.minor_allele = \"${cna.minorAllele}\", cna.mutation_type = \"${cna.mutationType}\"," +
                " cna.study_id = ${cna.studyId}, cna.grch = \"${cna.grch}\", " +
                " cna.chromosome_start_stop = \"${cna.chromosomeStartStop}\" " +
                " RETURN cna.cnv_id"
    )
